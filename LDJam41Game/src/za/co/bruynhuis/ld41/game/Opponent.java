 ...
 * @author NideBruyn
 */
public class Opponent extends BasicPlayer {
    ...
    public Opponent(BasicGame basicGame) {
        super(basicGame);
    }
    ...
    protected void init() {
        ...
        model = game.getBaseApplication().getAssetManager().loadModel("Models/player/opponent.j3o");
...
//                        Debug.log("Waypoint reached");
                        ...
                        if (waypoints.isEmpty()) {
                            ...
                            if (((Game) game).getTotalLaps() == lapCount && !gameEnded) {
                                ((Game) game).setWinner(Opponent.this);
